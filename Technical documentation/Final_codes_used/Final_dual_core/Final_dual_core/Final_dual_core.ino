...
//--------------------------------------------------------------
//            CONFIGURACIÓN PARA MULTITASKING 
//--------------------------------------------------------------
TaskHandle_t toSendTaskC0;  // Enviar datos por el Core 0
TaskHandle_t toSenseTaskC1; // Sensar datos por el Core 1
SemaphoreHandle_t batton;    // Señal de envío
...
//                  SETUP - MULTITASKING 
//--------------------------------------------------------------
xTaskCreatePinnedToCore(codeForTask0, "sendData", 10000, NULL, 0, &toSendTaskC0,  0);   //Núcleo 1
xTaskCreatePinnedToCore(codeForTask1, "senseData", 10000, NULL, 0, &toSenseTaskC1,  1);     //Núcleo 0
